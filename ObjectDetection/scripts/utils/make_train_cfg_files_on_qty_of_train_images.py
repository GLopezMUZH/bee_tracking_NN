...
#%%
dest_folder = 'C:\\Users\\glopez\\Google Drive\\yolo_models\\cfg_files\\yolo_train_files\\on_qty_of_train_images\\all\\'
...
for hive in hives:
    for nr_to_save in nr_files:
        ...
        file_name = hive + '_'+ str(nr_to_save) + '.data'
        ...
        ln_backup = "backup = /content/gdrive/My\ Drive/yolo_models/backup_yolo4/on_qty_of_train_images/" + hive + "_" + str(nr_to_save) + "/"
